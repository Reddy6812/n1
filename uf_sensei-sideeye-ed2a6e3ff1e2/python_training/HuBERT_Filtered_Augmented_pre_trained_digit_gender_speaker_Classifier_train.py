...
def main():
    augment_mode = "general"
    typs_to_create_models_for = [f'HuBERT_pretrained_filtered_DO05_FF_AUG_{augment_mode}_digit',
                                 f'HuBERT_pretrained_filtered_DO05_FF_AUG_{augment_mode}_gender',
                                 f'HuBERT_pretrained_filtered_DO05_FF_AUG_{augment_mode}_speaker']
    class_counts = [10, 1, 20]
    main_logger = setup_logger(f'main_log.log', '/blue/srampazzi/pnaghavi/test38_px2/main_train_HuBERT_spectral_log_HUBERT_filtered.log')
    typs_process_list = []
