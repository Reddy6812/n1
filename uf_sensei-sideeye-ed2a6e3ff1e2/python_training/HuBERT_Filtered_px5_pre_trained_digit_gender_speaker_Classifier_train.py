...
def spun_train_one_2D_CNN_spectral_classifier(device_instant, main_logger, type_label, num_classes, label_index):
    ...
    DATA_PATH = '/blue/srampazzi/pnaghavi/test38_cross_device/EXT_DATA_AUDIO_PX'
...
def main():
    typs_to_create_models_for = ['HuBERT_pretrained_filtered_DO05_px5_digit', 'HuBERT_pretrained_filtered_DO05_px5_gender', 'HuBERT_pretrained_filtered_DO05_px5_speaker']
