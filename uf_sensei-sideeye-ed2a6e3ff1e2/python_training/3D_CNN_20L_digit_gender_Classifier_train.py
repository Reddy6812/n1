...
def main():
    typs_to_create_models_for = ['20L_digit_NODOUT', '20L_gender_NoDOUT']
    class_counts = [10, 1]
    main_logger = setup_logger(f'main_log.log', '/blue/srampazzi/pnaghavi/test30/main_train_3D_CNN_log_2_dg.log')
    typs_process_list = []
    if torch.cuda.device_count() != 2:
        main_logger.info(f"Not enough GPU was allocated 2 was requested but {torch.cuda.device_count()} was provided")
        return
    else:
