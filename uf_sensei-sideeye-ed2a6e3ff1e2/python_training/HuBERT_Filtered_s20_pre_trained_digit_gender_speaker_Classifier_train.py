...
def spun_train_one_2D_CNN_spectral_classifier(device_instant, main_logger, type_label, num_classes, label_index):
    ...
    DATA_PATH = '/blue/srampazzi/pnaghavi/test38_cross_device/EXT_DATA_AUDIO_S'
...
def main():
    typs_to_create_models_for = ['HuBERT_pretrained_filtered_DO05_s20_digit', 'HuBERT_pretrained_filtered_DO05_s20_gender', 'HuBERT_pretrained_filtered_DO05_s20_speaker']
    class_counts = [10, 1, 20]
    main_logger = setup_logger(f'main_log.log', '/blue/srampazzi/pnaghavi/test38_cross_device/main_train_HuBERT_spectral_log_HUBERT_filtered_s20.log')
    typs_process_list = []
