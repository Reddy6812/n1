...
class CNNDecoderClassifier(nn.Module):
    def __init__(self, n_input=3, n_output=1, stride=16, n_channel=8):
        ...
        self.dropout10 = nn.Dropout(0.01)
        ...
        self.dropout11 = nn.Dropout(0.01)
        ...
        self.dropout12 = nn.Dropout(0.01)
        ...
        self.dropout13 = nn.Dropout(0.01)
        ...
        self.dropout14 = nn.Dropout(0.01)
        ...
        self.dropout15 = nn.Dropout(0.01)
        ...
        self.dropout16 = nn.Dropout(0.01)
        ...
        self.dropout17 = nn.Dropout(0.01)
        ...
        self.dropout18 = nn.Dropout(0.01)
        ...
        self.dropout19 = nn.Dropout(0.01)
...
def main():
    typs_to_create_models_for = ['20L_digit_NODOUT', '20L_gender_NoDOUT', '20L_speaker_NODOUT']
    class_counts = [10, 1, 20]
    main_logger = setup_logger(f'main_log.log', '/blue/srampazzi/pnaghavi/test30/main_train_3D_CNN_log_2.log')
    typs_process_list = []
    if torch.cuda.device_count() != 3:
        ...
        for index, type_str in enumerate(typs_to_create_models_for):
            typs_process_list.append(Process(target=spun_train_one_3D_CNN_decoder_classifier, args=('cuda:' + str(index), main_logger, type_str, class_counts[index], index)))
            # typs_process_list.append(Process(target=spun_test_one_3D_CNN_decoder_classifier, args=('cuda:' + str(index), main_logger, type_str, class_counts[index], index)))
