...
dir_path = '/blue/srampazzi/pnaghavi/Data/test38_px2_vol-10/audio/'
drop_path = '/blue/srampazzi/pnaghavi/test38_px2_vol-10/EXT_DATA_AUDIO/'
CSV_path = '/blue/srampazzi/pnaghavi/Data/test38_px2_vol-10/wordlog_py.csv'
BATCH_SIZE = 64
Num_worker = 48
MAX_LENGTH = 60000
SAMPLE_RATE = 30000
    ...
    for f in range(len(files[i * BATCH_SIZE: (i + 1) * BATCH_SIZE])):
        ...
        if sample_rate == -1:
            ...
            if sample_rate != data[0]:
                ...
                break
        np_wave_reduced_noise = noisereduce.subRSNoise(data[1], SAMPLE_RATE).swapaxes(1, 0)
